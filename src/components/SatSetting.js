...
//this is high ordered component
    ...
    showSatellite = e => {
        ...
        this.props.form.validateFields((err, values) => {
            if (!err) {
                ...
                //send satsetting to Main, child to parent data communication
                //this is child where we use this callback function to pass value to parent
