...
class SatelliteList extends Component {
    ...
    render() {
        ...
        //if client does not input any geo info, satinfo maybe null
                ...
                <hr/>
                {
                    isLoad ?
                        ...
                        <List className="sat-list"
                              ...
                              dataSource={satList}
                              renderItem={ item => (
                                  //every satellite info is one item, and be fetched to dataInfo
    ...
    showMap = () => {
        const { selected } = this.state;
        //use this callback func onshowmap() to pass selected satellite info to parent: main component
        //and finally to its sibling worldmap
